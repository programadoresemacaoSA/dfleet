...
class SiniastroAvariaWidget extends StatefulWidget {
  const SiniastroAvariaWidget({Key? key}) : super(key: key);

  @override
  _SiniastroAvariaWidgetState createState() => _SiniastroAvariaWidgetState();
}

class _SiniastroAvariaWidgetState extends State<SiniastroAvariaWidget> {
