...
import '../pdf_termo/pdf_termo_widget.dart';
...
class TermosWidget extends StatefulWidget {
  ...
  @override
  _TermosWidgetState createState() => _TermosWidgetState();
}
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(0, 18, 0, 1),
                          child: InkWell(
                            onTap: () async {
                              await Navigator.push(
                                context,
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    await Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => PdfTermoWidget(),
                                      ),
                                    );
                                  },
                                  child: Row(
