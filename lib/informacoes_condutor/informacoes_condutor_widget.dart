...
class InformacoesCondutorWidget extends StatefulWidget {
  const InformacoesCondutorWidget({Key? key}) : super(key: key);

  @override
  _InformacoesCondutorWidgetState createState() =>
      _InformacoesCondutorWidgetState();
}

class _InformacoesCondutorWidgetState extends State<InformacoesCondutorWidget>
