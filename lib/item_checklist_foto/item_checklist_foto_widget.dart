...
class ItemChecklistFotoWidget extends StatefulWidget {
  const ItemChecklistFotoWidget({Key? key}) : super(key: key);

  @override
  _ItemChecklistFotoWidgetState createState() =>
      _ItemChecklistFotoWidgetState();
}

class _ItemChecklistFotoWidgetState extends State<ItemChecklistFotoWidget> {
