...
class ChecklistCopyWidget extends StatefulWidget {
  const ChecklistCopyWidget({Key? key}) : super(key: key);

  @override
  _ChecklistCopyWidgetState createState() => _ChecklistCopyWidgetState();
}
