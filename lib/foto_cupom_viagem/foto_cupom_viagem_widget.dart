...
class FotoCupomViagemWidget extends StatefulWidget {
  const FotoCupomViagemWidget({Key? key}) : super(key: key);

  @override
  _FotoCupomViagemWidgetState createState() => _FotoCupomViagemWidgetState();
}

class _FotoCupomViagemWidgetState extends State<FotoCupomViagemWidget> {
